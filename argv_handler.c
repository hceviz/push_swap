...
/*   Updated: 2025/02/12 03:47:59 by hceviz           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "pushswap.h"

//it will check if there is problem, it will stop otherwise it will not do anything
void	check_args(int ac, char **av)
{
	...
	i = 0;
	if (ac == 2) // check when av[1][0] = NULL
	...
	//SHOULD I COUNT A.OUT FOR ALLOCATION SIZE IN FT_SPLIT?
	while (new_av[i])
	{
